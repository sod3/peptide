export const Logo = ({ className = "" }: { className?: string }) => (
  <a href="/" className={`flex items-center gap-2 ${className}`} aria-label="Aevum Bio">
    ...
    <div className="leading-none">
      <div className="font-display text-lg font-semibold tracking-tight">Aevum<span className="text-accent">.</span>Bio</div>
